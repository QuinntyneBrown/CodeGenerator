...
namespace CodeGenerator.DotNet;

public static class Constants
{
    public static string RootNamespace = nameof(CodeGenerator);
    ...
    {
        public const string DefaultCommand = $"CodeGenerator:{nameof(DefaultCommand)}";
    }
